...
<head>
    ...
    <link href="<?= css_url("sb-admin-2.min.css") ?>" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Utilities Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#proformat" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-fw fa-wrench"></i>
                    <span>Proformat</span>
                </a>
    ...
    <script src="<?= js_url("sb-admin-2.min.js") ?>"></script>

    <!-- Page level plugins -->
    <script src="<?= vendor_url("chart.js/Chart.min.js") ?>"></script>

    <!-- Page level custom scripts -->
    <script src="<?= js_url("demo/chart-area-demo.js") ?>"></script>
    <script src="<?= js_url("demo/chart-pie-demo.js") ?>"></script>
