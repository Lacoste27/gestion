...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link"  href="<?php echo site_url('index.php/Stock'); ?>">
             ...
             <li class="nav-item">
                <a class="nav-link"  href="<?php echo site_url('index.php/Stock/indexMouvement'); ?>">
                    
                    <i class="fas fa-fw fa-table"></i>
                    <span>Mouvement Stock</span></a>
            </li>
